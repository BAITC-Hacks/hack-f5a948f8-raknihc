...
Статус: начальный движок реализован в `backend/app/engine/`; контракт — `docs/api-contract.md`. LLM, полная валидация импорта и приложение остаются в плане.
...
Перед реализацией зафиксировать точные входные и выходные схемы в `docs/api-contract.md`.
